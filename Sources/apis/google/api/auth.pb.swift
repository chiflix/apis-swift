...
extension Google_Api_AuthenticationRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularMessageField(value: &self._oauth)
      case 5: try decoder.decodeSingularBoolField(value: &self.allowWithoutCredential)
      case 7: try decoder.decodeRepeatedMessageField(value: &self.requirements)
      default: break
      }
    }
  }
