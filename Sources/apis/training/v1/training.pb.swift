...
public struct Sagittarius_Training_V1_StreamingTrainingRequest {
  ...
  public var streamingRequest: Sagittarius_Training_V1_StreamingTrainingRequest.OneOf_StreamingRequest? = nil
...
extension Sagittarius_Training_V1_StreamingTrainingRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeSingularStringField(value: &self.transcript)
      case 4: try decoder.decodeSingularStringField(value: &self.mediaIdentity)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.transcript.isEmpty {
      try visitor.visitSingularStringField(value: self.transcript, fieldNumber: 3)
    }
    if !self.mediaIdentity.isEmpty {
      try visitor.visitSingularStringField(value: self.mediaIdentity, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
